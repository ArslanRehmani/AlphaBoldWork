                ...
                try {
                    ...
                    if (files) {
                        ...
                        if(!files.length){
                            ...
                            // htmlBtnData += '</SCRIPT>';
                            var htmlBtnData = '<br /> <br /><input type="button" onClick="uploadSharepointFile();"  id= "spFileUpload" value="Upload File" style="cursor:pointer" />';
                            htmlBtnData += '<SCRIPT language="JavaScript" type="text/javascript">';
                            ...
                            htmlBtnData += 'window.uploadSharepointFile = function (event){alert("working , Add Logic here");}';
                            htmlBtnData += '});';
                            htmlBtnData += '</SCRIPT>';
                            form.updateDefaultValues({
