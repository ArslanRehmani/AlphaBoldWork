            ...
            if (formId == '161' || formId == '136' || formId == '176') { // '161' its for Sale Order, '136' and '176' its for transfer order   
                if (sublist == 'item' && fieldId == 'item') {
                    ...
                    if (lineCount > 0) {
                            ...
                            if(!date)
                            {
                                    ...
                                    for(var x= 0 ; x < objKeys.length-1 ; x++){
                                        if(objKeys[x] != 'dateCreated'){
                                            ...
                                            stringMessage += 'Link :<a href="https://6485266-sb1.app.netsuite.com/app/common/custom/custrecordentry.nl?rectype=386&id='+stopOrderId +'">Stop Order Link</a> <br />';
                        ...
                        FirstLinestring = 'This Item has Stop Order(s): ';
